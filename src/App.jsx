...
function App() {
  return (
    <div className="relative min-h-screen bg-black text-white font-cascadia">
      <StaticBackground />
      <CustomCursor />
      <main className="relative p-6 z-10 flex flex-col md:flex-row items-center justify-between min-h-screen max-w-[1440px] mx-auto">
        {/* Left Side */}
        <div className="w-full md:w-1/2 text-center md:text-left order-2 md:order-1">
          <h1 className="text-4xl md:text-5xl font-bold text-white">Hello! I'm Joshua Kitong</h1>
          <p className="text-3xl mt-4 text-blue-500">Web Developer</p>
          ...
          {/* MeSVGArt for small screens only */}
